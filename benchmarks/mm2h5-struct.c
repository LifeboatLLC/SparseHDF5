 ...
 * and writes them into a two-dimensional structured chunk and compressed HDF5 dataset.
 *
 * Usage:
 *     ./mm2h5-struct <file.txt> <XC> <YC> <GZIP_LEVEL> [-v]
 *
 * Behavior:
 ...
 *
 * Example:
 *     ./mm2h5-struct data.txt 10 10 6 -v
